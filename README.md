...
Работу выполнила: Садовая Анастасия
...
> Примечание! Так как ответ LLM по API занимает какое-то время, перед началом диалога необходимо дождаться приветственного слова от агента(около 30 секунд после запуска проекта) и только потом начинать диалог.
